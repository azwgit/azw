...
public class MachineScanActivity extends BaseTitleActivity implements QRCodeView.Delegate{


    private static final String TAG = MachineScanActivity.class.getSimpleName();
