...
public class LibraryListScanActivity extends BaseTitleActivity implements QRCodeView.Delegate{


    private static final String TAG = LibraryListScanActivity.class.getSimpleName();
