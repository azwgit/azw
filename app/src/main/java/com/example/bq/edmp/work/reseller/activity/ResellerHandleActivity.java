...
public class ResellerHandleActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        xRecyclerView.setLayoutManager(new LinearLayoutManager(ResellerHandleActivity.this));
        ...
        resellerApplyAdapter.setOnItemLeftClckListener(new ResellerApplyAdapter.OnItemLeftClckListener() {
            ...
            public void onItemLeftClck(BaseAllocationBeam.DataBean.RowsBean rowsBean, int mPosition) {
                Intent intent = new Intent(ResellerHandleActivity.this, ResellerTrackDetailsActivity.class);
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(ResellerHandleActivity.this, 3));
...
//      lp.alpha = 9f; // 透明度
        ...
        buttom_rv.setLayoutManager(new LinearLayoutManager(ResellerHandleActivity.this));
    ...
    private void gainData() {
        ...
        RxHttpUtils.createApi(ResellerApi.class)
                .getHandleListShai(mCode, virtual_orgIds, currentPager, 15, mStatus, varietyId, sign)
