 ...
 */
public class AllocationApprovalListAdapter extends RecyclerView.Adapter<AllocationApprovalListAdapter.Holder> {

    private List<BaseAllocationBeam.DataBean.RowsBean> list;


    public AllocationApprovalListAdapter(List<BaseAllocationBeam.DataBean.RowsBean> list) {
        this.list = list;
    }
