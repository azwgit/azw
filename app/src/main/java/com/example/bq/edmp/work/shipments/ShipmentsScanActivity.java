...
public class ShipmentsScanActivity extends BaseTitleActivity implements QRCodeView.Delegate{


    private static final String TAG = ShipmentsScanActivity.class.getSimpleName();
