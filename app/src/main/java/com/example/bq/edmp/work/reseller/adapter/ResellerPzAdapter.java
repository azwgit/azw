...
public class ResellerPzAdapter extends RecyclerView.Adapter<ResellerPzAdapter.Holder> {
    private ArrayList<PzBean.DataBean> list;

    public ResellerPzAdapter(ArrayList<PzBean.DataBean> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int position) {
        final PzBean.DataBean dataBean = list.get(position);
...
//            holder.tv.setBackgroundResource(R.drawable.audit_ch_shape_no);
    ...
    public interface OnItemLeftClckListener {
        void onItemLeftClck(PzBean.DataBean dataBean, int mPosition);
    }
