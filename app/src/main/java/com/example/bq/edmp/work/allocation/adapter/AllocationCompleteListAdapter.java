 ...
 */
public class AllocationCompleteListAdapter extends RecyclerView.Adapter<AllocationCompleteListAdapter.Holder> {

    private List<BaseAllocationBeam.DataBean.RowsBean> list;


    public AllocationCompleteListAdapter(List<BaseAllocationBeam.DataBean.RowsBean> list) {
        this.list = list;
    }
