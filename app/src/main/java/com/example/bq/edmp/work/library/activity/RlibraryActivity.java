 ...
 * 入库
 * */
public class RlibraryActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks {
    ...
    private int type ;//入库类型
    private ArrayList<LibraryBean.DataBean.RowsBean> rowsBeans;
    ...
    protected int getLayoutId() {
        return R.layout.activity_rlibrary;
    }
    ...
    protected void initView() {
        ...
        libraryListAdapter = new LibraryListAdapter(rowsBeans, TYPE);
        xr.setAdapter(libraryListAdapter);
        xr.setPullRefreshEnabled(true);
        xr.setLoadingMoreEnabled(true);
        xr.setLayoutManager(new LinearLayoutManager(RlibraryActivity.this));
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(RlibraryActivity.this, 3));
        ...
        bz_rv.setLayoutManager(new GridLayoutManager(RlibraryActivity.this, 2));
    ...
    private void gainData() {
        ...
        RxHttpUtils.createApi(LibraryApi.class)
                .getRlibraryData(code, orgIds, packagingId, currentPager, 15, type2, varietyId, warehouseId, sign)
                .compose(Transformer.<LibraryBean>switchSchedulers())
                .subscribe(new NewCommonObserver<LibraryBean>() {
                    @Override
                    ...
                    @Override
                    protected void onSuccess(LibraryBean libraryBean) {
                        List<LibraryBean.DataBean.RowsBean> rows = libraryBean.getData().getRows();
        ...
        RxHttpUtils.createApi(LibraryApi.class)
                ...
                .subscribe(new NewCommonObserver<LibraryBean>() {
                    ...
                    protected void onSuccess(LibraryBean libraryBean) {
                        ...
                        if (rows != null && rows.size() != 0) {
                            rowsBeans.addAll(rows);
                            libraryListAdapter.addMoreData(rows);
                        } else {
                            xr.setNoMore(true);
                        }
                    }
...
//      lp.alpha = 9f; // 透明度
        ...
        buttom_rv.setLayoutManager(new LinearLayoutManager(RlibraryActivity.this));
    ...
    private void requestCodeQRCodePermissions() {
        ...
        if (!EasyPermissions.hasPermissions(this, perms)) {
            ...
            orgIds = "";
            varietyId = "";
            Intent intent = new Intent(RlibraryActivity.this, LibraryListScanActivity.class);
