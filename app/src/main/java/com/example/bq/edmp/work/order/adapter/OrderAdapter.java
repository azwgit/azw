...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.ViewHolder> {
    ...
    public OrderAdapter(ArrayList<OrderTJBean.DataBean.RowsBean> list) {
        this.list = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(ProApplication.getmContext()).inflate(R.layout.order_list_padater, null));
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        if (orderItem != null && orderItem.size() != 0) {
            ...
            OrderNeiAdapter orderNeiAdapter = new OrderNeiAdapter(orderItem);
