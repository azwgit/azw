...
public class AllListPackageAdp extends BaseQuickAdapter<AllpackageListBean.DataBean, BaseViewHolder> {
    public interface SaveEditListener{
        void SaveEdit(int position, String string);
    }
    public AllListPackageAdp(@Nullable List<AllpackageListBean.DataBean> data) {
