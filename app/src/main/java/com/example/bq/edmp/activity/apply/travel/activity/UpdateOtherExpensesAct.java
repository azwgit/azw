 ...
 * 添加开支项
 */
public class UpdateOtherExpensesAct extends BaseTitleActivity {

    public static Intent newIntent(Context context, PayInfoBean payInfoBean) {
        Intent intent = new Intent(context, UpdateOtherExpensesAct.class);
    ...
    protected void initData() {
                ...
                if (newSelectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(UpdateOtherExpensesAct.this).themeStyle(themeId).openExternalPreview(position, newSelectList);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(UpdateOtherExpensesAct.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(UpdateOtherExpensesAct.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
        ...
        RxPermissions permissions = new RxPermissions(UpdateOtherExpensesAct.this);
    ...
    private DeleteGridImageAdapter.onAddPicClickListener onAddPicClickListener = new DeleteGridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            if (mode) {
                ...
                PictureSelector.create(UpdateOtherExpensesAct.this)
