...
public class ChuNeiListAdapter extends RecyclerView.Adapter<ChuNeiListAdapter.ViewHolder> {

    private List<ChuLibraryBean.DataBean.RowsBean.StockSubItemsBean> list;

    public ChuNeiListAdapter(List<ChuLibraryBean.DataBean.RowsBean.StockSubItemsBean> list) {
        this.list = list;
    }
