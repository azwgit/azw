 ...
 */
public class AllocationInListAdapter extends RecyclerView.Adapter<AllocationInListAdapter.Holder> {

    private List<BaseAllocationBeam.DataBean.RowsBean> list;


    public AllocationInListAdapter(List<BaseAllocationBeam.DataBean.RowsBean> list) {
        this.list = list;
    }
