...
public class PinLiangListPackageAdp extends BaseQuickAdapter<AllpackageListBean.DataBean, BaseViewHolder> {
    public interface SaveEditListener{
        void SaveEdit(int position, String string);
    }
    public PinLiangListPackageAdp(@Nullable List<AllpackageListBean.DataBean> data) {
