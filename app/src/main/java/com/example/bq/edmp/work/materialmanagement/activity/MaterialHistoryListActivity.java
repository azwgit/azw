 ...
 * 退单跟踪
 * */
public class MaterialHistoryListActivity extends BaseActivity {
    @BindView(R.id.xr)
    ...
    protected void initView() {
        ProApplication.getinstance().addActivity(MaterialHistoryListActivity.this);
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(MaterialHistoryListActivity.this, 3));
...
//                            shaixuan_wsj.setVisibility(ViewGroup.VISIBLE);
    ...
    protected void onDestroy() {
        super.onDestroy();
        ProApplication.getinstance().finishActivity(MaterialHistoryListActivity.this);
    }
    ...
    private void gainData() {
        ...
        RxHttpUtils.createApi(MaterialManagementApi.class)
                .getMaterialHistoryList(varietyId, companyId, currentPager, 15, sign)
...
//      lp.alpha = 9f; // 透明度
        ...
        buttom_rv.setLayoutManager(new LinearLayoutManager(MaterialHistoryListActivity.this));
