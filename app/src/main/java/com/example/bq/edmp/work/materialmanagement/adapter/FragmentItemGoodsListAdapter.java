...
public class FragmentItemGoodsListAdapter extends RecyclerView.Adapter<FragmentItemGoodsListAdapter.ViewHolder> {
    private List<ProcurementTrackingListFragmentBean.DataBean.RowsBean.MaterialPurchaseItemsBean> list;

    public FragmentItemGoodsListAdapter(List<ProcurementTrackingListFragmentBean.DataBean.RowsBean.MaterialPurchaseItemsBean> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ProcurementTrackingListFragmentBean.DataBean.RowsBean.MaterialPurchaseItemsBean orderItem = list.get(position);
