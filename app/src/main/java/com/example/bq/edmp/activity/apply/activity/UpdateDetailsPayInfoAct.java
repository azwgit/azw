 ...
 * 添加开支项
 */
public class UpdateDetailsPayInfoAct extends BaseTitleActivity {

    public static Intent newIntent(Context context, IntetnCode intetnCode) {
        Intent intent = new Intent(context, UpdateDetailsPayInfoAct.class);
    ...
    protected void initData() {
                ...
                if (newSelectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(UpdateDetailsPayInfoAct.this).themeStyle(themeId).openExternalPreview(position, newSelectList);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(UpdateDetailsPayInfoAct.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(UpdateDetailsPayInfoAct.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
        ...
        RxPermissions permissions = new RxPermissions(UpdateDetailsPayInfoAct.this);
    ...
    private DeleteGridImageAdapter.onAddPicClickListener onAddPicClickListener = new DeleteGridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            if (mode) {
                ...
                PictureSelector.create(UpdateDetailsPayInfoAct.this)
