 ...
 * 退单跟踪
 * */
public class ProcurementTrackingListActivity extends BaseActivity {
    @BindView(R.id.xr)
    ...
    protected void initView() {
        ProApplication.getinstance().addActivity(ProcurementTrackingListActivity.this);
        title_tv.setText("采购跟踪");
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(ProcurementTrackingListActivity.this, 3));
        ...
        goodsSalesConfirmListAdapter.setOnItemClickListener(new FragmentProcurementTrackingListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int pos, ProcurementTrackingListFragmentBean.DataBean.RowsBean rowsBean) {
                ProcurementDetailsActivity.newIntent(getApplicationContext(), rowsBean.getId() + "");
            }
        });
    }
    ...
    private void addFragment() {
        ...
        for (int i = 0; i < integers.size(); i++) {
            ...
            fragmentList.add(new ProcurementTrackingListFragment(integers.get(i)));
        }
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if (adapter.getCount() > 0) {
                    goodsSalesTrackingListFragment = (ProcurementTrackingListFragment) adapter.getItem(tab.getPosition());
                }
...
//                            shaixuan_wsj.setVisibility(ViewGroup.VISIBLE);
    ...
    protected void onDestroy() {
        super.onDestroy();
        ProApplication.getinstance().finishActivity(ProcurementTrackingListActivity.this);
    }
    ...
    private void gainData() {
        currentPager = 1;
        String sign = MD5Util.encode("itemId=" + varietyId + "&orgId=" + companyId + "&page=" + currentPager + "&pagerow=" + 15 + "&status=" + 0);
        RxHttpUtils.createApi(MaterialManagementApi.class)
                .getMaterialManagementList(varietyId, companyId, currentPager, 15, 0, sign)
...
//      lp.alpha = 9f; // 透明度
        ...
        buttom_rv.setLayoutManager(new LinearLayoutManager(ProcurementTrackingListActivity.this));
