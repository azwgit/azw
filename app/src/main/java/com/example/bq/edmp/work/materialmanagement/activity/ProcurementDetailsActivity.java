...
public class ProcurementDetailsActivity extends BaseActivity {
    public static void newIntent(Context context, String id) {
        Intent intent = new Intent(context, ProcurementDetailsActivity.class);
    ...
    protected void initView() {
        ProApplication.getinstance().addActivity(ProcurementDetailsActivity.this);
            ...
            public void onItemClick(int position, View v) {
                if (imglist.size() > 0) {
                    ...
                    if (mediaType == 6) {
                        ...
                        list.add(localMedia);
                        PictureSelector.create(ProcurementDetailsActivity.this).themeStyle(themeId).openExternalPreview(0, list);
                        return;
                    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        ProApplication.getinstance().finishActivity(ProcurementDetailsActivity.this);
    }
