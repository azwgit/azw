...
public class DialoggerOk extends Dialog {
    ...
    private DialoggerOk(@NonNull Context context, String title, String message, int icon,
    ...
    public static class Builder {
        ...
        public DialoggerOk build() {
            return new DialoggerOk(mContext, mTitle, mMessage,mIcon,
