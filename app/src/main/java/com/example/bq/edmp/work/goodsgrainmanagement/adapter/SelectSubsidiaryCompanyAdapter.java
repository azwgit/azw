...
public class SelectSubsidiaryCompanyAdapter extends RecyclerView.Adapter<SelectSubsidiaryCompanyAdapter.Holder> {
    private List<SubsidiaryCompanyBean.DataBean> list;

    public SelectSubsidiaryCompanyAdapter(List<SubsidiaryCompanyBean.DataBean> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int position) {
        final SubsidiaryCompanyBean.DataBean dataBean = list.get(position);
...
//            holder.tv.setBackgroundResource(R.drawable.audit_ch_shape_no);
    ...
    public interface OnItemLeftClckListener {
        void onItemLeftClck(SubsidiaryCompanyBean.DataBean dataBean, int mPosition);
    }
