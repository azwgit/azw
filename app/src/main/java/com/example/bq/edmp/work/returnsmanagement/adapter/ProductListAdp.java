...
public class ProductListAdp extends BaseQuickAdapter<GoodsListBean.DataBean, BaseViewHolder> {
    public interface SaveEditListener{
        void SaveEdit(int position, String string);
    }
    public ProductListAdp(@Nullable List<GoodsListBean.DataBean> data) {
