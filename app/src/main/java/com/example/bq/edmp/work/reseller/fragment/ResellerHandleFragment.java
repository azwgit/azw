...
import com.example.bq.edmp.work.reseller.activity.ResellerHandleDetailsActivity;
...
public class ResellerHandleFragment extends BaseFragment {
    ...
    @SuppressLint("ValidFragment")
    public ResellerHandleFragment(String status) {
        mStatus = status;
    ...
    protected int getLayoutResource() {
        return R.layout.fragment_reseller_handle;
    }
    ...
    protected void initView() {
        ...
        resellerApplyAdapter.setOnItemLeftClckListener(new ResellerApplyAdapter.OnItemLeftClckListener() {
            ...
            public void onItemLeftClck(BaseAllocationBeam.DataBean.RowsBean rowsBean, int mPosition) {
                Intent intent = new Intent(getActivity(), ResellerHandleDetailsActivity.class);
    ...
    private void gainData() {
        ...
        RxHttpUtils.createApi(ResellerApi.class)
                .getHandleList(mCode, currentPager, 15, mStatus, sign)
