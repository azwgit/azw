...
public class AllNewListPackageAdp extends BaseQuickAdapter<AllpackageListBean.DataBean, BaseViewHolder> {
    public interface SaveEditListener{
        void SaveEdit(int position, String string);
    }
    public AllNewListPackageAdp(@Nullable List<AllpackageListBean.DataBean> data) {
