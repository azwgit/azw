...
public class MaterialConfirmListAdapter extends RecyclerView.Adapter<MaterialConfirmListAdapter.ViewHolder> {
    private List<ProcurementTrackingListFragmentBean.DataBean.RowsBean> list;

    public MaterialConfirmListAdapter(ArrayList<ProcurementTrackingListFragmentBean.DataBean.RowsBean> list) {
        this.list = list;
    }
