...
public class AddActivitiesActivity extends BaseTitleActivity {
    public static void newIntent(Context context) {
        Intent intent = new Intent(context, AddActivitiesActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.activity_addactivitys;
    }
