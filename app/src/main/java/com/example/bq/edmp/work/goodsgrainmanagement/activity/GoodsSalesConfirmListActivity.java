...
import com.example.bq.edmp.work.goodsgrainmanagement.fragment.GoodsSalesConfirmListFragment;
...
public class GoodsSalesConfirmListActivity extends BaseActivity {
    ...
    private GoodsSalesConfirmListFragment goodsSalesTrackingListFragment;
    ...
    protected void initView() {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(GoodsSalesConfirmListActivity.this, 3));
        ...
        goodsSalesConfirmListAdapter.setOnItemClickListener(new GoodsSalesConfirmListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int pos, GoodsSalesManagementListBean.DataBean.RowsBean rowsBean) {
                GoodsSalesConfirmDetailsActivity.newIntent(getApplicationContext(), rowsBean.getId() + "");
            }
        });
    }
    ...
    private void addFragment() {
        ...
        for (int i = 0; i < integers.size(); i++) {
            ...
            fragmentList.add(new GoodsSalesConfirmListFragment(integers.get(i)));
        }
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if (adapter.getCount() > 0) {
                    goodsSalesTrackingListFragment = (GoodsSalesConfirmListFragment) adapter.getItem(tab.getPosition());
                }
...
//      lp.alpha = 9f; // 透明度
        ...
        buttom_rv.setLayoutManager(new LinearLayoutManager(GoodsSalesConfirmListActivity.this));
