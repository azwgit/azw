 ...
 */
public class YmachineListAdapter extends RecyclerView.Adapter<YmachineListAdapter.Holder> {

    private List<MachineListBean.DataBean.RowsBean> list;

    public YmachineListAdapter(List<MachineListBean.DataBean.RowsBean> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int position) {
        ...
        holder.jiagongliang_tv.setText("加工量:   " + rowsBean.getFinishedQty() + " 公斤");
        holder.jihuatime_tv.setText("计划完成时间" + rowsBean.getPlanFinishTime());
        holder.shijitime_tv.setText("实际完成时间" + rowsBean.getFinishedTime());
