...
public class MaterialGoodsListAdapter extends RecyclerView.Adapter<MaterialGoodsListAdapter.Holder> {
    private ArrayList<VarietiesBean.DataBean> list;

    public MaterialGoodsListAdapter(ArrayList<VarietiesBean.DataBean> list) {
        this.list = list;
    }
