 ...
 */
public class JmachineListAdapter extends RecyclerView.Adapter<JmachineListAdapter.Holder> {

    private List<MachineListBean.DataBean.RowsBean> list;

    public JmachineListAdapter(List<MachineListBean.DataBean.RowsBean> list) {
        this.list = list;
    }
