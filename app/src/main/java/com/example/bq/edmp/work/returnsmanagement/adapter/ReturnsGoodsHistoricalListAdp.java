...
public class ReturnsGoodsHistoricalListAdp extends RecyclerView.Adapter<ReturnsGoodsHistoricalListAdp.Holder> {

    private List<ReturnTrackingListBean.DataBean.RowsBean> list;

    public ReturnsGoodsHistoricalListAdp(List<ReturnTrackingListBean.DataBean.RowsBean> list) {
        this.list = list;
    }
    ...
    @NonNull
    @Override
    public ReturnsGoodsHistoricalListAdp.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(ProApplication.getmContext()).inflate(R.layout.item_returns_activity_list, null));
    }

    @Override
    public void onBindViewHolder(@NonNull ReturnsGoodsHistoricalListAdp.Holder holder, final int position) {
    ...
    protected ReturnsGoodsHistoricalListAdp.OnItemClickListener mItemClickListener;

    public interface OnItemClickListener {
        void onItemClick(int pos, ReturnTrackingListBean.DataBean.RowsBean rowsBean);
    }

    public void setOnItemClickListener(ReturnsGoodsHistoricalListAdp.OnItemClickListener listener) {
