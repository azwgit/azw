...
public class AllPurchaseGoodsAdp extends BaseQuickAdapter<AllpackageListBean.DataBean, BaseViewHolder> {
    public interface SaveEditListener{
        void SaveEdit(int position, String string);
    }
    public AllPurchaseGoodsAdp(@Nullable List<AllpackageListBean.DataBean> data) {
